...
def main():
    ...
    st.caption("    	:white_check_mark: **반드시 파일을 먼저 첨부한 뒤 OPENAPI KEY를 입력해주세요.**")
    st.caption("    	:white_check_mark: 	**LISBOT은 첨부한 자료를 기반으로 한 답변을 제공합니다. 자료를 업로드하고 궁금한 점을 물어보세요**     :speech_balloon:")
