...
def main():
    ...
    st.caption("        :information_desk_person: *This app is developed for the Introduction to Data Science course project for Spring 2024.Feel free to ask any questions to LISBOT. Whether you're looking for research help, resource recommendations, or answers to specific questions, LISBOT is here to assist you.*")
