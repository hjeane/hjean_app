...
def main():
    ...
    st.caption("        :loudspeaker: *Welcome to the Library and Information Science Q&A chat.*")
    st.caption("        :information_desk_person: *This app is developed for the Introduction to Data Science course project for Spring 2024.*")
    st.caption("        :pushpin:  *Feel free to ask any questions to LISBOT. Whether you're looking for research help, resource recommendations, or answers to specific questions, LISBOT is here to assist you.*")
